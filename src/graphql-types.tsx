...
export type GetCvPaginatedQueryVariables = Exact<{
  workLimit: Scalars['Int']['input'];
  workSkip: Scalars['Int']['input'];
}>;

export type GetCvPaginatedQuery = {
  __typename?: 'Query';
  cvCollection?:
    | {
        __typename?: 'CvCollection';
...
export type GetCvQueryResult = Apollo.QueryResult<
  ...
  GetCvQueryVariables
>;
export const GetCvPaginatedDocument = gql`
...
/**
 * __useGetCvPaginatedQuery__
 *
 * To run a query within a React component, call `useGetCvPaginatedQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetCvPaginatedQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetCvPaginatedQuery({
 *   variables: {
 *      workLimit: // value for 'workLimit'
 *      workSkip: // value for 'workSkip'
 *   },
 * });
 */
export function useGetCvPaginatedQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetCvPaginatedQuery,
    GetCvPaginatedQueryVariables
  > &
    (
      | { variables: GetCvPaginatedQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetCvPaginatedQuery, GetCvPaginatedQueryVariables>(
    GetCvPaginatedDocument,
    options,
  );
}
export function useGetCvPaginatedLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetCvPaginatedQuery, GetCvPaginatedQueryVariables>(
    GetCvPaginatedDocument,
    options,
  );
}
export function useGetCvPaginatedSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
  ...
  return Apollo.useSuspenseQuery<
    GetCvPaginatedQuery,
    GetCvPaginatedQueryVariables
  >(GetCvPaginatedDocument, options);
}
export type GetCvPaginatedQueryHookResult = ReturnType<
  typeof useGetCvPaginatedQuery
>;
export type GetCvPaginatedLazyQueryHookResult = ReturnType<
  typeof useGetCvPaginatedLazyQuery
>;
export type GetCvPaginatedSuspenseQueryHookResult = ReturnType<
  typeof useGetCvPaginatedSuspenseQuery
>;
export type GetCvPaginatedQueryResult = Apollo.QueryResult<
  GetCvPaginatedQuery,
  GetCvPaginatedQueryVariables
>;
