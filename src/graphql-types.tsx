...
export type GetMoreWorkHistoryQueryVariables = Exact<{
  cvName: Scalars['String']['input'];
  limit: Scalars['Int']['input'];
  skip: Scalars['Int']['input'];
}>;

export type GetMoreWorkHistoryQuery = {
  __typename?: 'Query';
  cvCollection?:
    | {
        __typename?: 'CvCollection';
...
export const CvFragmentDoc = gql`
  fragment Cv on Cv {
    ...
    workHistoryCollection(limit: $workHistoryLimit) {
      items {
        ...WorkHistory
      }
      limit
...
export const GetCvDocument = gql`
  query GetCv($workHistoryLimit: Int = 5) {
...
export type GetCvQueryResult = Apollo.QueryResult<
  ...
  GetCvQueryVariables
>;
export const GetMoreWorkHistoryDocument = gql`
  query GetMoreWorkHistory($cvName: String!, $limit: Int!, $skip: Int!) {
    cvCollection(limit: 1, where: { name: $cvName }) {
      items {
        workHistoryCollection(limit: $limit, skip: $skip) {
          items {
            ...WorkHistory
          }
          limit
...
/**
 * __useGetMoreWorkHistoryQuery__
 *
 * To run a query within a React component, call `useGetMoreWorkHistoryQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetMoreWorkHistoryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetMoreWorkHistoryQuery({
 *   variables: {
 *      cvName: // value for 'cvName'
 *      limit: // value for 'limit'
 *      skip: // value for 'skip'
 *   },
 * });
 */
export function useGetMoreWorkHistoryQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetMoreWorkHistoryQuery,
    GetMoreWorkHistoryQueryVariables
  > &
    (
      | { variables: GetMoreWorkHistoryQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetMoreWorkHistoryQuery,
    GetMoreWorkHistoryQueryVariables
  >(GetMoreWorkHistoryDocument, options);
}
export function useGetMoreWorkHistoryLazyQuery(
...
export function useGetMoreWorkHistorySuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
...
export type GetMoreWorkHistoryQueryHookResult = ReturnType<
  typeof useGetMoreWorkHistoryQuery
>;
export type GetMoreWorkHistoryLazyQueryHookResult = ReturnType<
  typeof useGetMoreWorkHistoryLazyQuery
>;
export type GetMoreWorkHistorySuspenseQueryHookResult = ReturnType<
  typeof useGetMoreWorkHistorySuspenseQuery
>;
export type GetMoreWorkHistoryQueryResult = Apollo.QueryResult<
  GetMoreWorkHistoryQuery,
  GetMoreWorkHistoryQueryVariables
>;
