...
export type GetWorkHistoryQueryVariables = Exact<{
  limit?: InputMaybe<Scalars['Int']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
}>;
...
export const CvFragmentDoc = gql`
  fragment Cv on Cv {
    ...
    workHistoryCollection(limit: $workHistoryLimit, skip: $workHistorySkip) {
      total
      items {
        ...WorkHistory
      }
...
export const GetCvDocument = gql`
  query GetCv($workHistoryLimit: Int = 5, $workHistorySkip: Int = 0) {
...
export type GetCvQueryResult = Apollo.QueryResult<
  ...
  GetCvQueryVariables
>;
export const GetWorkHistoryDocument = gql`
  query GetWorkHistory($limit: Int = 5, $skip: Int = 0) {
    workHistoryCollection(limit: $limit, skip: $skip, order: [dateTo_DESC]) {
      total
      items {
        ...WorkHistory
      }
...
/**
 * __useGetWorkHistoryQuery__
 *
 * To run a query within a React component, call `useGetWorkHistoryQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetWorkHistoryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetWorkHistoryQuery({
 *   variables: {
 ...
 * });
 */
export function useGetWorkHistoryQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetWorkHistoryQuery,
    GetWorkHistoryQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetWorkHistoryQuery, GetWorkHistoryQueryVariables>(
    GetWorkHistoryDocument,
    options,
  );
}
export function useGetWorkHistoryLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetWorkHistoryQuery, GetWorkHistoryQueryVariables>(
    GetWorkHistoryDocument,
    options,
  );
}
export function useGetWorkHistorySuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
  ...
  return Apollo.useSuspenseQuery<
    GetWorkHistoryQuery,
    GetWorkHistoryQueryVariables
  >(GetWorkHistoryDocument, options);
}
export type GetWorkHistoryQueryHookResult = ReturnType<
  typeof useGetWorkHistoryQuery
>;
export type GetWorkHistoryLazyQueryHookResult = ReturnType<
  typeof useGetWorkHistoryLazyQuery
>;
export type GetWorkHistorySuspenseQueryHookResult = ReturnType<
  typeof useGetWorkHistorySuspenseQuery
>;
export type GetWorkHistoryQueryResult = Apollo.QueryResult<
  GetWorkHistoryQuery,
  GetWorkHistoryQueryVariables
>;
