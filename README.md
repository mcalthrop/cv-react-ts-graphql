...
- **AI Rules**: Shared AI coding rules managed via a `git subtree` from [mcalthrop/ai-skills](https://github.com/mcalthrop/ai-skills), referenced in `CLAUDE.md` for use with Claude Code
